"""
Training and evaluation routines for MNIST classification networks.

Provides training, evaluation, and plotting support for both the deep
and shallow models depending on input parameter.
"""
...
from Dnn.deep_nn import DeepNet
from Shallow_nn.shallow_nn import FeedForwardNet
